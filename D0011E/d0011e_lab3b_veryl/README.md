...
All the Veryl code together with a README file will be uploaded to GitLab. The README file will include the tables and the answers to the questions in this document, include the text and the index of the question for it to be traced. Remember also to add the images to the zip file you submit in Canvas.
...
# Part 3 Upload the Veryl project and the README file created during the lab, remember:

- **ALU implementation for all 5 instructions.**
- **Program counter, show the waveform of your Q output for a couple of Clk cycles, with the Reset signal set both high and low.**
